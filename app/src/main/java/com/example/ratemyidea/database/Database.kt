package com.example.ratemyidea.database
...
class Database(context: Context) {
    ...
    init {
        ...
        database.execSQL("CREATE TABLE IF NOT EXISTS alreadyRatedIdeas (uuid TEXT NOT NULL PRIMARY KEY)".trimIndent())
    }
    ...
    fun insertAlreadyRatedIdea (
        ...
        database.insert("alreadyRatedIdeas", null, values)
    }

    fun alreadyRatedIdeas(): List<String> {
        val list = mutableListOf<String>()
        val cursor = database.rawQuery("SELECT * FROM alreadyRatedIdeas", null)
